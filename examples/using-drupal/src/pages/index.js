  ...
  render() {
    ...
    const FirstPromoted = ({ recipe }) => (
      ...
      >
        ...
        <Img
          fluid={recipe.relationships.image.localFile.localFile.childImageSharp.fluid}
        />
      </Link>
    )
      ...
      >
        ...
        <div
          css={{
            padding: `${rhythm(3 / 4)} ${rhythm(1)}`,
            width:
              recipe.relationships.image.localFile.localFile.childImageSharp.fluid.width,
            height: square
              ? recipe.relationships.image.localFile.localFile.childImageSharp.fluid
                  .height
              : undefined,
          }}
        >
